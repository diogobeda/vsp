...
func (handler *ChannelHandler) GetChannels(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		handler.webHandler.Internal(w, "There was a problem when fetching the channels")
		return
	}
...
func (handler *ChannelHandler) UpdateChannel(w http.ResponseWriter, r *http.Request) {
	...
	if decodeErr != nil {
		handler.webHandler.BadRequest(w, "There was a problem when updating the channel")
		return
	}
...
func (handler *ChannelHandler) RemoveChannel(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		handler.webHandler.BadRequest(w, "There was a problem when removing the channel")
		return
	}

	handler.webHandler.NoContent(w)
}
